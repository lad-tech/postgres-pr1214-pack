...
module.exports.cleanClose = cleanClose;function cleanClose() {
  let attempts = 0
    , closes = 0
  const retries = []
...
module.exports.queuedClose = queuedClose;function queuedClose() {
  return peer(() => 'close', {
    connect_timeout: 0.1,
    backoff: 0.025
  }, async sql => {
...
module.exports.closeBackoff = closeBackoff;function closeBackoff() {
  let attempts = 0
  return peer(() => (++attempts, 'close'), {
    connect_timeout: 0.1,
    backoff: 2
...
module.exports.closeRecovery = closeRecovery;function closeRecovery() {
  let attempts = 0
...
module.exports.closeReset = closeReset;function closeReset() {
  let attempts = 0
...
module.exports.reserveCloseReset = reserveCloseReset;function reserveCloseReset() {
  let attempts = 0
  const retries = []
  return peer(() => ++attempts % 3 ? 'close' : 'ready', {
    connect_timeout: 0.15,
...
module.exports.closeErrorReset = closeErrorReset;function closeErrorReset() {
  let attempts = 0
